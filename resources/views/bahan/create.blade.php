    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid ">
            <div id="kt_app_content_container" class="app-container  container-fluid ">
                <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" method="POST" action="{{ route('bahan.store') }}">
                    @csrf
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-0 fv-row">
                                                ...
                                                <input type="text" name="nama_bahan" class="form-control mb-0" required
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-0 fv-row">
                                                ...
                                                <input type="number" name="harga_satuan_bahan" class="form-control mb-0" required
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-0 fv-row">
                                                ...
                                                <input type="number" name="stok_bahan" class="form-control mb-0" step="0.05" required
