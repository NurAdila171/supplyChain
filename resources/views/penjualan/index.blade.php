                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-start">Tgl Jual</th>
                            ...
                            @foreach($penjualan as $row)
                                <tr class="text-success">
                                    ...
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">{{ ($row->nama_produk) }}</span>
                                    </td>
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">{{ ($row->jumlah) }}</span>
                                    </td>
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">{{ ($row->tgl_jual) }}</span>
                                    </td>
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">Rp{{ ($row->jumlah * $row->harga_produk) }},-</span>
                                    </td>
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">{{ ($row->layanan) }}</span>
                                    </td>
                                    <td class="text-start pe-0">
