                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <a href="{{ route('produk.bahan.create', $produk->id) }}"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px">Kebutuhan Bahan</th>
                                <th class="min-w-200px">Limitasi</th>
                                <th class="min-w-200px">Satuan</th>
                                <th class="text-end min-w-100px">Harga Satuan Bahan</th>
                            ...
                            @foreach($produk_bahan as $row)
                                <tr>
                                    ...
                                    <td class="text-start pe-0">
                                        <span class="fw-bold ms-3">{{ ($row->kebutuhan_bahan) }}</span>
                                    </td>
                                    <td class="text-start pe-0">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('produk.bahan.edit', [$row->produk_id, $row->id]) }}"
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="{{ route('produk.bahan.destroy', [$row->produk_id, $row->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
