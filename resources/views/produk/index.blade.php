                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-100px">Harga Produk</th>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{ route('produk.edit', $row->id) }}"
                                               class="symbol symbol-150px">
                                                <span class="symbol-label"
                                                      style="background-image:url({{ url('uploads/gambar_produk/' . $row->gambar_produk)  }});"></span>
                                            </a>

                                            <div class="ms-5">
                                                <a href="{{ route('produk.edit', $row->id) }}"
                                                   class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                                   data-kt-ecommerce-product-filter="product_name">{{ $row->nama_produk }}</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-0">
                                        <span class="fw-bold ms-3">Rp{{ ($row->harga_produk) }},-</span>
                                    </td>
                                    <td class="text-end">
                                        <a href="#"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('produk.bahan', $row->id) }}"
